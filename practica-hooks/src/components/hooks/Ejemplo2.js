  ...
  return (
    <div>
      ...
      <h3 ref={miRef} /*Elemento rederenciado con miRef*/>
        Elemento Referenciado caso 1: {contador1} - {contador2} (se muestra
        tabla en la consola al modificar cualquier estadp)
      </h3>

      <h3 ref={miRef2} /*Elemento rederenciado con miRef*/>
        Elemento Referenciado caso 2: {contador1} - {contador2} (se muestra
        tabla en la consola solo al modificar contador 1)
      </h3>

      <h3 ref={miRef3} /*Elemento rederenciado con miRef*/>
        Elemento Referenciado caso 3: {contador1} - {contador2} (se muestra
        tabla en la consola al modificar un estado indicado en el array
        [contador1, contador 2] (cualquiera))
      </h3>
